...
start_date=st.date_input(label="Start Date",value='1866-01-01', min_value=datetime.date(year=1870, month=12, day=31), max_value=datetime.date(year=2022, month=12, day=31))
